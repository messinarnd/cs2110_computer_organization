...
public class Operations
{
    ...
    {
        // basically which << 3 = which * 2^3
        // If which = 0 = 00, then leftshift by 3 -> 00000
        // which = 1 = 01, then leftshift by 3 -> 01000 = 8 (hence shift by 8 bits)
        // which = 2 = 10, then leftshift by 3 -> 10000 = 16 (shift by 16 bits)
        // which = 3 = 11, then leftshift by 3 -> 11000 = 24 (shift by 24 bits)
        // 0xFF = 11111111 (8 ones)
        // num >> by 0,8,16, or 24 bits
    ...
    {
        // Do the same shift as before but clear all original bits then set to new bits
    ...
    {
        // Why does this not work? Maybe 31 leading 0's then a one?
//        return (num & ((0x1 >> (n - 1)) << s)) >> s;
        return (num & (~(0xFFFFFFFF << n) << s)) >> s;
    }
